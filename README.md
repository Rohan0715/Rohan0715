...
<head>
    ...
    <style>
        ...
        .content {
            padding-top: 200px; /* Adjust this value based on the height of your fixed image */
        }
    </style>
</head>
<body>
    <img src="https://github.com/Rohan0715/MasterHead/blob/main/poster1.gif" alt="MasterHead" class="masterhead" />
    ...
    <div class="content">
        ...
        <ul>
            <li>🌱 I’m currently learning <strong>Android Development, EDA, ML, NLP, GEN AI</strong></li>
            <li>💬 Ask me about <strong>Android Development, EDA, ML, NLP, GEN AI</strong></li>
            <li>📫 How to reach me <strong>rohanpatel0715@gmail.com</strong></li>
        </ul>
